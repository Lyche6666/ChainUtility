...
#[derive(Debug)]
pub struct ChainUtilityProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChainUtilityProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChainUtility processing");
    
    let mut processor = ChainUtilityProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChainUtilityProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChainUtilityProcessor::new(false);
